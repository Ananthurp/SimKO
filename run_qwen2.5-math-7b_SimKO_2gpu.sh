...
# SimKO Training Script - Modified for 2 Blackwell RTX 6000 GPUs
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="MATH-Qwen2.5-7B-SimKO-2GPU-Blackwell" \
...
# 6. rollout.gpu_memory_utilization=0.65 - Increased from 0.5 (you have 98GB VRAM)
